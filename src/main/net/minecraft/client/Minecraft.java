...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        this.mcLanguageManager = new LanguageManager(this.metadataSerializer_, this.gameSettings.particleSetting);
        ...
        if (this.gameSettings.particleSetting != null)
        {
        ...
        AchievementList.openInventory.setStatStringFormatter(new IStatStringFormat()
        {
            public String formatString(String p_74535_1_)
            {
                try
                {
                    return String.format(p_74535_1_, new Object[] {GameSettings.getKeyDisplayString(Minecraft.this.gameSettings.keyBindSprint.getKeyCode())});
                }
    ...
    {
        return this.mcLanguageManager.isCurrentLocaleUnicode() || this.gameSettings.language;
    }
    ...
    private void runGameLoop() throws IOException
    {
        ...
        if (this.gameSettings.thirdPersonView && this.gameSettings.showDebugInfo && !this.gameSettings.difficulty)
        {
    ...
    public void runTick() throws IOException
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                        ...
                        if (k == 59)
                        {
                            this.gameSettings.difficulty = !this.gameSettings.difficulty;
                        }

                        if (k == 61)
                        {
                            this.gameSettings.thirdPersonView = !this.gameSettings.thirdPersonView;
                            this.gameSettings.showDebugInfo = GuiScreen.isShiftKeyDown();
                            this.gameSettings.showDebugProfilerChart = GuiScreen.isAltKeyDown();
                        }
                        ...
                        if (this.gameSettings.keyBindScreenshot.isPressed())
                        {
                            ...
                            if (this.gameSettings.hideGUI > 2)
                            {
                                this.gameSettings.hideGUI = 0;
                            }

                            if (this.gameSettings.hideGUI == 0)
                            {
                                this.entityRenderer.loadEntityShader(this.getRenderViewEntity());
                            }
                            else if (this.gameSettings.hideGUI == 1)
                            {
                        ...
                        {
                            this.gameSettings.lastServer = !this.gameSettings.lastServer;
                        }
                    }

                    if (this.gameSettings.thirdPersonView && this.gameSettings.showDebugInfo)
                    {
                        if (k == 11)
                        {
            ...
            for (int l = 0; l < 9; ++l)
            {
                if (this.gameSettings.keyBindStreamToggleMic[l].isPressed())
                {
                    if (this.thePlayer.isSpectator())
                    {
            ...
            while (this.gameSettings.keyBindSprint.isPressed())
            {
            ...
            while (this.gameSettings.keyBindPickBlock.isPressed() && flag)
            {
                this.displayGuiScreen(new GuiChat());
            }

            if (this.currentScreen == null && this.gameSettings.keyBindPlayerList.isPressed() && flag)
            {
                this.displayGuiScreen(new GuiChat("/"));
            }
            ...
            if (this.gameSettings.keyBindInventory.isKeyDown() && this.rightClickDelayTimer == 0 && !this.thePlayer.isUsingItem())
            {
                this.rightClickMouse();
            }

            this.sendClickBlockToController(this.currentScreen == null && this.gameSettings.keyBindDrop.isKeyDown() && this.inGameHasFocus);
        }
    ...
    {
        return theMinecraft == null || !theMinecraft.gameSettings.difficulty;
    }
        ...
        if (i != 0 && !Keyboard.isRepeatEvent())
        {
            if (!(this.currentScreen instanceof GuiControls) || ((GuiControls)this.currentScreen).time <= getSystemTime() - 20L)
            {
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else if (i == this.gameSettings.keyBindStreamStartStop.getKeyCode())
                    {
                        if (this.getTwitchStream().isBroadcasting())
                        {
                    ...
                    else if (i == this.gameSettings.keyBindCommand.getKeyCode())
                    {
