...
public abstract class GuiContainer extends GuiScreen
{
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        ...
        boolean flag = mouseButton == this.mc.gameSettings.keyBindAttack.getKeyCode() + 100;
        ...
        if (mouseButton == 0 || mouseButton == 1 || flag)
        {
            ...
            if (l != -1)
            {
                ...
                else if (!this.dragSplitting)
                {
                    ...
                    {
                        if (mouseButton == this.mc.gameSettings.keyBindAttack.getKeyCode() + 100)
                        {
                    ...
                    else
                    {
                        ...
                        else if (mouseButton == this.mc.gameSettings.keyBindAttack.getKeyCode() + 100)
                        {
    ...
    protected void mouseReleased(int mouseX, int mouseY, int state)
    {
        ...
        else
        {
            ...
            {
                if (state == this.mc.gameSettings.keyBindAttack.getKeyCode() + 100)
                {
    ...
    {
        if (keyCode == 1 || keyCode == this.mc.gameSettings.keyBindSprint.getKeyCode())
        {
        ...
        {
            if (keyCode == this.mc.gameSettings.keyBindAttack.getKeyCode())
            {
                this.handleMouseClick(this.theSlot, this.theSlot.slotNumber, 0, 3);
            }
            else if (keyCode == this.mc.gameSettings.keyBindUseItem.getKeyCode())
            {
    ...
    protected boolean checkHotbarKeys(int keyCode)
    {
        if (this.mc.thePlayer.inventory.getItemStack() == null && this.theSlot != null)
        {
            for (int i = 0; i < 9; ++i)
            {
                if (keyCode == this.mc.gameSettings.keyBindStreamToggleMic[i].getKeyCode())
                {
