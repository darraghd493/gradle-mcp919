...
public class GuiScreenRealmsProxy extends GuiScreen
{
    ...
    {
        super.drawString(this.fontRendererObj, p_154319_1_, p_154319_2_, p_154319_3_, p_154319_4_);
    }
    ...
    public void c(String p_c_1_, int p_c_2_, int p_c_3_, int p_c_4_)
    {
        this.fontRendererObj.drawStringWithShadow(p_c_1_, (float)p_c_2_, (float)p_c_3_, p_c_4_);
    }
