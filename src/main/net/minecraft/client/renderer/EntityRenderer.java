...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private float getFOVModifier(float partialTicks, boolean p_78481_2_)
    {
        ...
        else
        {
            ...
            if (p_78481_2_)
            {
                f = this.mc.gameSettings.debugCamEnable;
    ...
    private void orientCamera(float partialTicks)
    {
        ...
        else if (this.mc.gameSettings.hideGUI > 0)
        {
            ...
            else
            {
                ...
                if (this.mc.gameSettings.hideGUI == 2)
                {
                    f2 += 180.0F;
                }
    ...
    private void renderHand(float partialTicks, int xOffset)
    {
        if (!this.debugView)
        {
            ...
            if (this.mc.gameSettings.hideGUI == 0 && !flag && !this.mc.gameSettings.difficulty && !this.mc.playerController.isSpectator())
            {
                this.enableLightmap();
            ...
            if (this.mc.gameSettings.hideGUI == 0 && !flag)
            {
        ...
        if (this.lightmapUpdateNeeded)
        {
            ...
            if (world != null)
            {
                ...
                for (int i = 0; i < 256; ++i)
                {
                    ...
                    float f16 = this.mc.gameSettings.fovSetting;
                    float f17 = 1.0F - f8;
                    float f13 = 1.0F - f9;
                    float f14 = 1.0F - f10;
    ...
    public void func_181560_a(float p_181560_1_, long p_181560_2_)
    {
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            if (this.mc.theWorld != null)
            {
                ...
                if (!this.mc.gameSettings.difficulty || this.mc.currentScreen != null)
                {
    ...
    private boolean isDrawBlockOutline()
    {
        ...
        {
            Entity entity = this.mc.getRenderViewEntity();
            boolean flag = entity instanceof EntityPlayer && !this.mc.gameSettings.difficulty;
    ...
    {
        if (this.mc.gameSettings.thirdPersonView && !this.mc.gameSettings.difficulty && !this.mc.thePlayer.hasReducedDebug() && !this.mc.gameSettings.reducedDebugInfo)
        {
            Entity entity = this.mc.getRenderViewEntity();
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        ActiveRenderInfo.updateRenderInfo(this.mc.thePlayer, this.mc.gameSettings.hideGUI == 2);
    ...
    private void addRainParticles()
    {
        ...
        if (f != 0.0F)
        {
            ...
            else if (this.mc.gameSettings.guiScale == 2)
            {
                k = 0;
            }
