...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onLivingUpdate()
    {
        ...
        {
            if (this.sprintToggleTimer <= 0 && !this.mc.gameSettings.keyBindSneak.isKeyDown())
            {
        ...
        if (!this.isSprinting() && this.movementInput.moveForward >= f && flag3 && !this.isUsingItem() && !this.isPotionActive(Potion.blindness) && this.mc.gameSettings.keyBindSneak.isKeyDown())
        {
            this.setSprinting(true);
        }
